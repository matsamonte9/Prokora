...
# Message helper available in all templates
...
app.config["SESSION_COOKIE_NAME"] = "session"  # ✅ You asked to use 'session'
...
# Prevent session creation before login
@app.before_request
def prevent_session_creation():
    if "user_id" not in session:
        session.modified = False

# Template test for intersecting lists
